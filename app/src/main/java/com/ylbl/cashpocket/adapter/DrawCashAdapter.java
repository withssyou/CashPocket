...
public class DrawCashAdapter extends BaseRecyclerArrayAdapter<DrawCashInfo> {
    private Context context;
    private List<DrawCashInfo> objects;
    public DrawCashAdapter(Context context, List<DrawCashInfo> objects) {
    ...
    public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_draw_cash_record_done, parent ,false);
